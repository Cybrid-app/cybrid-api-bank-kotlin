    ...
    constructor(
        ...
        authNames.forEach { authName ->
            val auth = when (authName) {
                "BearerAuth" -> HttpBearerAuth("bearer")"oauth2" -> OAuth(OAuthFlow.application, "", "https://id.demo.cybrid.app/oauth/token", "banks:read, banks:write, accounts:read, accounts:execute, customers:read, customers:write, customers:execute, prices:read, quotes:execute, quotes:read, trades:execute, trades:read, rewards:execute, rewards:read, external_bank_accounts:read, external_bank_accounts:execute, workflows:read, workflows:execute")
    ...
    */
    ...
    companion object {
        ...
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(baseUrlKey, "https://bank.demo.cybrid.app")
        }
    }
}
