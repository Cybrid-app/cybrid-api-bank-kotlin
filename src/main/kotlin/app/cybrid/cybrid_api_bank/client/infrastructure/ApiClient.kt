...
open class ApiClient(val baseUrl: String) {
    companion object {
        ...
        const val baseUrlKey = "app.cybrid.cybrid_api_bank.client.baseUrl"
    ...
    protected inline fun <reified T: Any?> responseBody(body: ResponseBody?, mediaType: String? = JsonMediaType): T? {
        ...
        if (T::class.java == File::class.java) {
            // return tempfile
            val f = java.nio.file.Files.createTempFile("tmp.app.cybrid.cybrid_api_bank.client", null).toFile()
            f.deleteOnExit()
