...
import app.cybrid.cybrid_api_bank.client.models.CounterpartyAddressBankModel
import app.cybrid.cybrid_api_bank.client.models.CounterpartyAliasesInnerBankModel
import app.cybrid.cybrid_api_bank.client.models.CounterpartyNameBankModel
 ...
 * 
 *
 * @param guid Auto-generated unique identifier for the counterparty.
 * @param type The counterparty type; one of business or individual.
 * @param bankGuid Auto-generated unique identifier for the counterparty's bank.
 * @param customerGuid Auto-generated unique identifier for the counterparty's customer.
 ...
 * @param state The counterparty state; one of storing, unverified, verified, or rejected.
 * @param name 
 * @param address 
 * @param aliases The counterparty's aliases. Only available for GET operations when 'include_pii' is set.
 * @param dateOfBirth The counterparty's DOB. Only available for GET operations when 'include_pii' is set.
 * @param labels The labels associated with the counterparty.
 * @param complianceDecisions The compliance decisions associated with the counterparty.
 * @param verificationChecks Deprecated; use compliance_decisions instead.
 */

data class CounterpartyBankModel (
    ...
    @SerializedName("name")
    val name: CounterpartyNameBankModel? = null,

    @SerializedName("address")
    val address: CounterpartyAddressBankModel? = null,

    /* The counterparty's aliases. Only available for GET operations when 'include_pii' is set. */
    @SerializedName("aliases")
    val aliases: kotlin.collections.List<CounterpartyAliasesInnerBankModel>? = null,
