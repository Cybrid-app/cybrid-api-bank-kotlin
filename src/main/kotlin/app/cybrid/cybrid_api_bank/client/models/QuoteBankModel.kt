...
import app.cybrid.cybrid_api_bank.client.models.QuoteEntryBankModel
 ...
 * @param productType The type of product the quote is for; one of trading, trading_exit, funding, book_transfer, crypto_transfer, inter_account, or lightning_transfer.
 ...
 * @param propertyEntries The quote entries for a batch transfer quote
 * @param tradeGuid The unique identifier for the trade.
 * @param transferGuid The unique identifier for the transfer.
 */
...
data class QuoteBankModel (
    ...
    val propertyEntries: kotlin.collections.List<QuoteEntryBankModel>? = null,
    ...
    @SerializedName("transfer_guid")
    val transferGuid: kotlin.String? = null
