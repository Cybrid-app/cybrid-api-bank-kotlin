 ...
 * @param provider The account provider, if applicable.
 ...
 * @param bankGuid The bank identifier associated with the account.
 * @param customerGuid The customer identifier associated with the account.
 * @param platformBalance The amount of funds that are in the account, in base units of the asset.
 * @param platformAvailable The amount of funds that are in the account, in base units of the asset, that are available for use on the platform.
...
data class AccountBankModel (
    ...
    /* The account type. */
    @SerializedName("type")
    val type: AccountBankModel.Type? = null,

    /* The account provider, if applicable. */
    @SerializedName("provider")
    val provider: AccountBankModel.Provider? = null,
    ...
    @SerializedName("platform_balance")
    val platformBalance: java.math.BigDecimal? = null,

    /* The amount of funds that are in the account, in base units of the asset, that are available for use on the platform. */
    @SerializedName("platform_available")
    val platformAvailable: java.math.BigDecimal? = null,

    /* The account's state. */
    @SerializedName("state")
    val state: AccountBankModel.State? = null
     ...
     * The account type.
     *
     * Values: backstopped,trading,fee,savings,staking
     */
    enum class Type(val value: kotlin.String) {
        @SerializedName(value = "backstopped") backstopped("backstopped"),
        @SerializedName(value = "trading") trading("trading"),
        @SerializedName(value = "fee") fee("fee"),
        @SerializedName(value = "savings") savings("savings"),
        @SerializedName(value = "staking") staking("staking");
    }
    /**
     * The account provider, if applicable.
     *
