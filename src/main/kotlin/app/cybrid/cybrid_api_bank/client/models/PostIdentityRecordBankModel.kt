...
import app.cybrid.cybrid_api_bank.client.models.PostIdentityRecordAttestationDetailsBankModel
...
data class PostIdentityRecordBankModel (
    ...
    @SerializedName("type")
    val type: PostIdentityRecordBankModel.Type,

    @SerializedName("attestation_details")
    val attestationDetails: PostIdentityRecordAttestationDetailsBankModel
