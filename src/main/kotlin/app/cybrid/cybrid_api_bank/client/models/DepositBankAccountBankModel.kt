 ...
 * @param type The account type; one of main or sub_account.
 ...
 * @param state The state of the address; one of storing or created.
 ...
 * @param parentDepositBankAccountGuid The unique identifier for the bank-level deposit bank account. This is only set for sub-accounts.
...
data class DepositBankAccountBankModel (
    ...
    @SerializedName("parent_deposit_bank_account_guid")
    val parentDepositBankAccountGuid: kotlin.String? = null,
