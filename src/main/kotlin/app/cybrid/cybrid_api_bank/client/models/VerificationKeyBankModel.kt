 ...
 * 
 *
 * @param guid Auto-generated unique identifier for the verification key.
 * @param bankGuid The banks's identifier.
 * @param type The verification key's type.
 * @param state The verification key's state.
 * @param failureCode The verification key's failure code (if any).
 * @param algorithm The verification key's algorithm.
 * @param fingerprint The verification key's cryptographic fingerprint.
 * @param createdAt ISO8601 datetime the verification key was created at.
 */

data class VerificationKeyBankModel (
    ...
    @SerializedName("type")
    val type: VerificationKeyBankModel.Type? = null,

    /* The verification key's state. */
    @SerializedName("state")
    val state: VerificationKeyBankModel.State? = null,

    /* The verification key's failure code (if any). */
    @SerializedName("failure_code")
    val failureCode: VerificationKeyBankModel.FailureCode? = null,

    /* The verification key's algorithm. */
    @SerializedName("algorithm")
    val algorithm: VerificationKeyBankModel.Algorithm? = null,
    ...
    enum class Type(val value: kotlin.String) {
        @SerializedName(value = "attestation") attestation("attestation");
    }
    /**
     * The verification key's state.
     *
     * Values: storing,pending,verified,failed
     */
     ...
     * The verification key's failure code (if any).
     *
     * Values: algorithm,nonce,publicKey,signature
     */
    enum class FailureCode(val value: kotlin.String) {
        @SerializedName(value = "invalid_algorithm") algorithm("invalid_algorithm"),
        @SerializedName(value = "invalid_nonce") nonce("invalid_nonce"),
        @SerializedName(value = "invalid_public_key") publicKey("invalid_public_key"),
        @SerializedName(value = "invalid_signature") signature("invalid_signature");
    }
    /**
     * The verification key's algorithm.
     *
    ...
    enum class Algorithm(val value: kotlin.String) {
        @SerializedName(value = "RS512") rS512("RS512");
    }
}
