...
import app.cybrid.cybrid_api_bank.client.models.ComplianceCheckBankModel
import app.cybrid.cybrid_api_bank.client.models.ComplianceDecisionBankModel
import app.cybrid.cybrid_api_bank.client.models.IdentityVerificationBusinessAssociateBankModel
import app.cybrid.cybrid_api_bank.client.models.IdentityVerificationDocumentBankModel
import app.cybrid.cybrid_api_bank.client.models.IdentityVerificationWithDetailsPiiBankModel
 ...
 * @param type The identity verification type; one of kyc, bank_account, or counterparty.
 * @param method The identity verification method; one of attested, document_submission, enhanced_due_diligence, id_and_selfie, tax_id_and_selfie, business_registration, attested_id_and_selfie, attested_business_registration, watchlists, attested_ownership, or account_ownership.
 ...
 * @param customerGuid The identity verification's identifier.
 * @param counterpartyGuid The identity verification's identifier.
 * @param externalBankAccountGuid The identity verification's identifier.
 * @param state The identity verification state; one of storing, waiting, pending, reviewing, expired, or completed.
 * @param outcome The identity verification outcome; one of passed or failed.
 * @param failureCodes The reason codes explaining the outcome.
 * @param complianceChecks The compliance checks associated with the identity verification.
 * @param complianceDecisions The compliance decisions associated with the identity verification.
 * @param personaInquiryId The Persona identifier of the backing inquiry.
 * @param personaState The Persona state of the backing inquiry; one of waiting, pending, reviewing, processing, expired, completed, or unknown.
 * @param businessAssociates List of associates declared for the business customer.
 * @param pii 
 * @param documents The documents associated with the identity verification.
 * @param supportingFiles The supporting documents associated with the attested identity verification.
 */
...
data class IdentityVerificationWithDetailsBankModel (
    ...
    @SerializedName("compliance_checks")
    val complianceChecks: kotlin.collections.List<ComplianceCheckBankModel>? = null,

    /* The compliance decisions associated with the identity verification. */
    @SerializedName("compliance_decisions")
    val complianceDecisions: kotlin.collections.List<ComplianceDecisionBankModel>? = null,
    ...
    val personaState: kotlin.String? = null,

    /* List of associates declared for the business customer. */
    @SerializedName("business_associates")
    val businessAssociates: kotlin.collections.List<IdentityVerificationBusinessAssociateBankModel>? = null,

    @SerializedName("pii")
    val pii: IdentityVerificationWithDetailsPiiBankModel? = null,

    /* The documents associated with the identity verification. */
    @SerializedName("documents")
    val documents: kotlin.collections.List<IdentityVerificationDocumentBankModel>? = null,

    /* The supporting documents associated with the attested identity verification. */
    @SerializedName("supporting_files")
    val supportingFiles: kotlin.collections.List<IdentityVerificationDocumentBankModel>? = null
