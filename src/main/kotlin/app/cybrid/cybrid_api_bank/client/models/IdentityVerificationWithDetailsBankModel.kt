...
data class IdentityVerificationWithDetailsBankModel (
     ...
     * The identity verification method.
     *
     * Values: idAndSelfie,attested,plaidIdentityMatch
     */
     ...
     * The reason codes explaining the outcome.
     *
     * Values: requestedFailure,idCheckFailure,databaseCheckFailure,selfieFailure,pepCheckFailure,mediaCheckFailure,watchlistCheckFailure,nameCheckFailure,addressCheckFailure,dobCheckFailure,idNumberCheckFailure,phoneNumberCheckFailure,emailAddressCheckFailure,decisionTimeout,plaidFailure
     */
    enum class FailureCodes(val value: kotlin.String) {
        ...
        @SerializedName(value = "media_check_failure") mediaCheckFailure("media_check_failure"),
        ...
        @SerializedName(value = "phone_number_check_failure") phoneNumberCheckFailure("phone_number_check_failure"),
        @SerializedName(value = "email_address_check_failure") emailAddressCheckFailure("email_address_check_failure"),
        @SerializedName(value = "decision_timeout") decisionTimeout("decision_timeout"),
        @SerializedName(value = "plaid_failure") plaidFailure("plaid_failure");
    }
    /**
     * The Persona state of the backing inquiry.
     *
