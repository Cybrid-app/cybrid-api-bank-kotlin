 ...
 * @param method The identity verification method; one of business_registration, id_and_selfie, tax_id_and_selfie, attested, attested_ownership, account_ownership, plaid_identity_match, document_submission, or watchlists.
 ...
 * @param verificationChecks Deprecated; use compliance_decisions instead.
...
data class IdentityVerificationWithDetailsBankModel (
    ...
    @SerializedName("verification_checks")
    val verificationChecks: kotlin.collections.List<ComplianceDecisionBankModel>? = null,
