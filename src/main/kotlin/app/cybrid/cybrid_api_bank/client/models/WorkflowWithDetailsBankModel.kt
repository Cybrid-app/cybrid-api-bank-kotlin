...
import app.cybrid.cybrid_api_bank.client.models.WorkflowWithDetailsAllOfBankModel
 ...
 * @param plaidLinkToken The Plaid link token generated by the workflow.
 */

data class WorkflowWithDetailsBankModel (
    ...
    @SerializedName("type")
    val type: WorkflowWithDetailsBankModel.Type? = null,

    /* The state of the workflow. */
    @SerializedName("state")
    val state: WorkflowWithDetailsBankModel.State? = null,
    ...
    @SerializedName("plaid_link_token")
    val plaidLinkToken: kotlin.String? = null
