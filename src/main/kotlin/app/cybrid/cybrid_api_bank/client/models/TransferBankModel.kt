 ...
 * @param side The direction of the quote: 'deposit' or 'withdrawal'.
 * @param state The transfer's state
 * @param failureCode The failure code for failed transfers.
...
data class TransferBankModel (
     ...
     * The type of transfer.
     *
     * Values: funding,book,crypto,instantFunding,fundingReturn,cryptoReturn
     */
    enum class TransferType(val value: kotlin.String) {
        ...
        @SerializedName(value = "funding_return") fundingReturn("funding_return"),
        @SerializedName(value = "crypto_return") cryptoReturn("crypto_return");
    }
    /**
     * The direction of the quote: 'deposit' or 'withdrawal'.
     *
