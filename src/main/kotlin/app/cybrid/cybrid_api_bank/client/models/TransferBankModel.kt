...
data class TransferBankModel (
     ...
     * The type of transfer.
     *
     * Values: savings,funding,book,crypto,internalBankRebalance,internalWalletRebalance,instantFunding
     */
    enum class TransferType(val value: kotlin.String) {
        ...
        @SerializedName(value = "internal_bank_rebalance") internalBankRebalance("internal_bank_rebalance"),
        @SerializedName(value = "internal_wallet_rebalance") internalWalletRebalance("internal_wallet_rebalance"),
