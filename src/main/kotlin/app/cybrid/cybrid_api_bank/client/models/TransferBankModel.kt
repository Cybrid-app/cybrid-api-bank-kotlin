...
import app.cybrid.cybrid_api_bank.client.models.TransferEntryBankModel
import app.cybrid.cybrid_api_bank.client.models.TransferParticipantBankModel
import app.cybrid.cybrid_api_bank.client.models.TransferSourceAccountBankModel
 ...
 * 
 *
 * @param guid Auto-generated unique identifier for the transfer.
 * @param transferType The type of transfer; one of funding, book, crypto, instant_funding, funding_return, crypto_return, loss_recovery, inter_account, lightning, or instant_funding_return.
 * @param bankGuid The associated bank's identifier.
 * @param customerGuid The associated customer's identifier.
 * @param quoteGuid The associated quote's identifier.
 * @param externalBankAccountGuid The associated external bank account's identifier.
 * @param asset The asset the transfer is related to, e.g., USD.
 * @param side The direction of the quote; one of deposit or withdrawal.
 * @param state The state of the transfer; one of storing, pending, reviewing, completed, or failed.
 * @param failureCode The failure code for failed transfers; one of non_sufficient_funds, refresh_required, party_name_invalid, payment_rail_invalid, compliance_rejection, cancelled, reversed, limit_exceeded, network_fee_too_low, amount_too_low, internal_error, or invalid_address.
 * @param returnCode The return code for reversed transfers
 * @param amount The actual amount in base units of the asset.
 * @param estimatedAmount The estimated amount in base units of the asset.
 * @param fee The fee associated with the transfer.
 * @param estimatedNetworkFee The estimated network fee in base units of network_fee_asset. Only present on `crypto` transfers.
 * @param networkFee The actual network fee in base units of network_fee_asset. Only present on `crypto` transfers that have successfully completed.
 * @param networkFeeAsset The asset code of the network fee. Only present on `crypto` transfers that have successfully completed.
 * @param networkFeeLiabilityAmount The equivalent fiat network fee in base units of network_fee_liability_amount_asset. Only present on `crypto` transfers that have successfully completed.
 * @param networkFeeLiabilityAmountAsset The fiat asset the network_fee_liability_amount is denominated in. Only present on `crypto` transfers that have successfully completed.
 * @param txnHash The hash of the blockchain transaction
 * @param referenceTransferGuid The guid of the related transfer. Only present on return type transfers.
 * @param sourceAccount 
 * @param sourceParticipants The participants in the source account.
 * @param destinationAccount 
 * @param destinationParticipants The participants in the source account.
 * @param depositAddressGuid The guid of the deposit address. Only present on crypto deposits.
 ...
 * @param holdStartedAt ISO8601 datetime the transfer hold was started at.
 * @param holdDuration The approximate time (in seconds) that the transfer will be held for.
 * @param transferDetails The raw details on the transfer from the bank.
 * @param paymentRail The rail the payment was done on. One of: ach, eft, wire, rtp
 * @param labels The labels associated with the transfer.
 * @param propertyEntries Transfer entries associated with the batch transfer
 */
...
data class TransferBankModel (
    ...
    val estimatedAmount: java.math.BigDecimal? = null,
    ...
    val estimatedNetworkFee: java.math.BigDecimal? = null,
    ...
    val networkFeeLiabilityAmount: java.math.BigDecimal? = null,
    ...
    val networkFeeLiabilityAmountAsset: kotlin.String? = null,

    /* The hash of the blockchain transaction */
    @SerializedName("txn_hash")
    val txnHash: kotlin.String? = null,

    /* The guid of the related transfer. Only present on return type transfers. */
    @SerializedName("reference_transfer_guid")
    val referenceTransferGuid: kotlin.String? = null,

    @SerializedName("source_account")
    val sourceAccount: TransferSourceAccountBankModel? = null,

    /* The participants in the source account. */
    @SerializedName("source_participants")
    val sourceParticipants: kotlin.collections.List<TransferParticipantBankModel>? = null,

    @SerializedName("destination_account")
    val destinationAccount: TransferDestinationAccountBankModel? = null,

    /* The participants in the source account. */
    @SerializedName("destination_participants")
    val destinationParticipants: kotlin.collections.List<TransferParticipantBankModel>? = null,

    /* The guid of the deposit address. Only present on crypto deposits. */
    @SerializedName("deposit_address_guid")
    val depositAddressGuid: kotlin.String? = null,
    ...
    val propertyEntries: kotlin.collections.List<TransferEntryBankModel>? = null
