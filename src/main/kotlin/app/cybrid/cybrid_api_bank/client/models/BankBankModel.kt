...
data class BankBankModel (
    ...
    val routableAccounts: BankBankModel.RoutableAccounts? = null,
     ...
     * The bank's enabled features.
     *
     * Values: attestationIdentityRecords,kycIdentityVerifications,rawRoutingDetails,individualCustomers,businessCustomers
     */
