...
data class BankBankModel (
     ...
     * The bank's enabled features.
     *
     * Values: attestationIdentityRecords,kycIdentityVerifications,backstoppedFundingSource,plaidFundingSource
     */
    enum class Features(val value: kotlin.String) {
        ...
        @SerializedName(value = "plaid_funding_source") plaidFundingSource("plaid_funding_source");
    }
}
