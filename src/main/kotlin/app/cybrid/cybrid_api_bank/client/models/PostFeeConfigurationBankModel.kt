 ...
 * 
 *
 * @param productType The type of product being configured.
 * @param asset The asset code.
 * @param fees The fees associated with the configuration
 * @param productProvider The provider for the product being configured.
 */

data class PostFeeConfigurationBankModel (

    /* The type of product being configured. */
    @SerializedName("product_type")
    val productType: PostFeeConfigurationBankModel.ProductType,
    ...
    @SerializedName("fees")
    val fees: kotlin.collections.List<PostFeeBankModel>,

    /* The provider for the product being configured. */
    @SerializedName("product_provider")
    val productProvider: PostFeeConfigurationBankModel.ProductProvider? = null
