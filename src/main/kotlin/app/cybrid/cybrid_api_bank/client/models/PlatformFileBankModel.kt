 ...
 * @param uploadExpiresAt The ISO8601 datetime the upload URL expires at.
 * @param downloadUrl The URL to download the file from.
 * @param downloadExpiresAt The ISO8601 datetime the download URL expires at.
 */
...
data class PlatformFileBankModel (
    ...
    val uploadUrl: java.net.URI? = null,

    /* The ISO8601 datetime the upload URL expires at. */
    @SerializedName("upload_expires_at")
    val uploadExpiresAt: java.time.OffsetDateTime? = null,
    ...
    @SerializedName("download_expires_at")
    val downloadExpiresAt: java.time.OffsetDateTime? = null
