 ...
 * @param tradeType The type of trade; one of platform, liquidation, or exit.
 ...
 * @param side The direction of the trade; one of buy or sell.
 * @param state The state of the trade; one of storing, pending, cancelled, completed, settling, or failed.
 * @param failureCode The failure code for failed trades; one of non_sufficient_funds, unsupported, limit_exceeded, expired_quote, or market_volatility.
 ...
 * @param labels The labels associated with the trade.
 */
...
data class TradeBankModel (
    ...
    val tradeType: kotlin.String? = null,
