 ...
 * @param failureCode The failure code for failed trades.
 ...
 * @param createdAt ISO8601 datetime the trade was created at.
...
data class TradeBankModel (
    ...
    val tradeType: TradeBankModel.TradeType? = null,
     ...
     * The type of trade.
     *
     * Values: platform,liquidation
     */
    enum class TradeType(val value: kotlin.String) {
        @SerializedName(value = "platform") platform("platform"),
        @SerializedName(value = "liquidation") liquidation("liquidation");
    }
    /**
     * The direction of the quote: either 'buy' or 'sell'.
     *
     ...
     * The trade's state
     *
     * Values: storing,pending,cancelled,completed,settling,failed
     */
