...
data class CustomerBankModel (
    ...
    /* The customer's type. */
    @SerializedName("type")
    val type: CustomerBankModel.Type? = null,
    ...
    val state: CustomerBankModel.State? = null,
    ...
    enum class Type(val value: kotlin.String) {
        ...
        @SerializedName(value = "individual") individual("individual");
    }
    /**
     * The customer's state.
     *
     * Values: storing,unverified,verified,rejected,frozen
     */
