...
import app.cybrid.cybrid_api_bank.client.models.VerificationCheckBankModel
 ...
 * @param verificationChecks The verification checks associated with the customer.
 */
...
data class CustomerBankModel (
    ...
    val verificationChecks: kotlin.collections.List<VerificationCheckBankModel>? = null
