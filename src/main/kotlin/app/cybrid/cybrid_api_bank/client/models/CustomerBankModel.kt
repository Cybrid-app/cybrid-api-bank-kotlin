...
import app.cybrid.cybrid_api_bank.client.models.ActivityLimitBankModel
import app.cybrid.cybrid_api_bank.client.models.ComplianceDecisionBankModel
import app.cybrid.cybrid_api_bank.client.models.CustomerAddressBankModel
import app.cybrid.cybrid_api_bank.client.models.CustomerAliasesInnerBankModel
import app.cybrid.cybrid_api_bank.client.models.CustomerNameBankModel
import app.cybrid.cybrid_api_bank.client.models.IdentificationNumberBankModel
 ...
 * 
 *
 * @param guid Auto-generated unique identifier for the customer.
 * @param bankGuid Auto-generated unique identifier for the customer's bank.
 * @param type The customer type; one of business or individual.
 ...
 * @param state The customer state; one of storing, unverified, verified, rejected, or frozen.
 * @param name 
 * @param address 
 * @param aliases The customer's aliases. Only available for GET operations when 'include_pii' is set.
 * @param website The customer's website. Only available for GET operations when 'include_pii' is set.
 * @param dateOfBirth The customer's DOB. Only available for GET operations when 'include_pii' is set.
 * @param phoneNumber The customer's phone number. Only available for GET operations when 'include_pii' is set.
 * @param emailAddress The customer's email address. Only available for GET operations when 'include_pii' is set.
 * @param labels The labels associated with the customer.
 * @param complianceDecisions The compliance decisions associated with the customer.
 * @param identificationNumbers The customer's identification numbers. Only available for GET operations when 'include_pii' is set and bank has access.
 * @param activityLimits The asset limits associated with the customer.
 */

data class CustomerBankModel (
    ...
    @SerializedName("name")
    val name: CustomerNameBankModel? = null,

    @SerializedName("address")
    val address: CustomerAddressBankModel? = null,

    /* The customer's aliases. Only available for GET operations when 'include_pii' is set. */
    @SerializedName("aliases")
    val aliases: kotlin.collections.List<CustomerAliasesInnerBankModel>? = null,
    ...
    val identificationNumbers: kotlin.collections.List<IdentificationNumberBankModel>? = null,

    /* The asset limits associated with the customer. */
    @SerializedName("activity_limits")
    val activityLimits: kotlin.collections.List<ActivityLimitBankModel>? = null
