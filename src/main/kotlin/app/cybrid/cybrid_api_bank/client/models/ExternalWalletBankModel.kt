 ...
 * 
 *
 * @param guid Auto-generated unique identifier for the wallet.
 * @param name The name of the wallet.
 * @param asset The asset code.
 * @param environment The environment that the wallet is configured for.
 ...
 * @param createdAt ISO8601 datetime the wallet was created at.
...
data class ExternalWalletBankModel (
     ...
     * The state of an external wallet
     *
     * Values: storing,pending,failed,completed,deleting,deleted
     */
