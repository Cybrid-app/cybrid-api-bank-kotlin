...
import app.cybrid.cybrid_api_bank.client.models.PostFeeBankModel
import app.cybrid.cybrid_api_bank.client.models.PostQuoteEntryBankModel
 ...
 * @param asset The asset code the quote was requested for. Required when product_type is lightning_transfer, product_type is book_transfer, product_type is funding, product_type is crypto_transfer, or product_type is inter_account.
 * @param networkAddress The network address to pay the invoice to. Required when product_type is lightning_transfer.
 * @param fees The custom fees associated with the quote Optional when product_type is lightning_transfer, product_type is funding, product_type is trading, product_type is crypto_transfer, or product_type is trading_exit.
 ...
 * @param symbol Symbol the quote is being requested for. Format is \"asset-counter_asset\" in uppercase. See the Symbols API for a complete list of cryptocurrencies supported.  Required when product_type is trading.
 * @param destinationAccounts Destination accounts for batch transactions Optional when product_type is crypto_transfer.
 * @param referenceTradeGuid The guid of the related trade. Only present on `exit` trades. Required when product_type is trading_exit.
 * @param sourceAccountGuid The source account's identifier. Required when product_type is inter_account.
 * @param destinationAccountGuid The destination account's identifier. Required when product_type is inter_account.
 */
...
data class PostQuoteBankModel (
    ...
    val networkAddress: kotlin.String? = null,
    ...
    @SerializedName("fees")
    val fees: kotlin.collections.List<PostFeeBankModel>? = null,

    /* The direction for trade quotes: either 'buy' or 'sell'. The direction for funding quotes: either 'deposit' or 'withdrawal'. The direction for crypto transfer quotes: 'withdrawal'. Book transfers do not require a side. They are all 'deposit's.  Required when product_type is funding, product_type is trading, or product_type is crypto_transfer. */
    @SerializedName("side")
    val side: PostQuoteBankModel.Side? = null,
    ...
    val destinationAccounts: kotlin.collections.List<PostQuoteEntryBankModel>? = null,
    ...
    val referenceTradeGuid: kotlin.String? = null,
     ...
     * The type of product the quote is for.
     *
     * Values: trading,tradingExit,funding,cryptoTransfer,interAccount,lightningTransfer,bookTransfer
     */
    enum class ProductType(val value: kotlin.String) {
        @SerializedName(value = "trading") trading("trading"),
        @SerializedName(value = "trading_exit") tradingExit("trading_exit"),
        @SerializedName(value = "funding") funding("funding"),
        @SerializedName(value = "crypto_transfer") cryptoTransfer("crypto_transfer"),
        @SerializedName(value = "inter_account") interAccount("inter_account"),
        @SerializedName(value = "lightning_transfer") lightningTransfer("lightning_transfer"),
        @SerializedName(value = "book_transfer") bookTransfer("book_transfer");
    }
    /**
     * The direction for trade quotes: either 'buy' or 'sell'. The direction for funding quotes: either 'deposit' or 'withdrawal'. The direction for crypto transfer quotes: 'withdrawal'. Book transfers do not require a side. They are all 'deposit's.  Required when product_type is funding, product_type is trading, or product_type is crypto_transfer.
     *
     * Values: deposit,withdrawal,buy,sell
     */
