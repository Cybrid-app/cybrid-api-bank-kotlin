 ...
 * @param asset The asset code the quote was requested for. Populated for funding, book transfer and crypto transfer quotes.
 * @param networkAddress The network address to pay the invoice to. Populated for lightning_transfer quotes.
 ...
 * @param side The direction for trade quotes: either 'buy' or 'sell'. The direction for funding quotes: either 'deposit' or 'withdrawal'. The direction for crypto transfer quotes: 'withdrawal'. Book transfers do not require a side. They are all 'deposit's. 
 ...
 * @param fees The custom fees associated with the quote
 * @param referenceTradeGuid The guid of the related trade. Only present on `exit` trades.
 * @param sourceAccountGuid The source account's identifier. Required for inter-account transfers.
 * @param destinationAccountGuid The destination account's identifier. Required for inter-account transfers.
 */
