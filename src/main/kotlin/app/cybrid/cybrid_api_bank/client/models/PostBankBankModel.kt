 ...
 * @param type The bank's type. At present, only **sandbox** is supported.
 * @param supportedTradingSymbols The bank's list of supported trading symbols.
 * @param features The bank's enabled features.
 * @param supportedFiatAccountAssets The bank's list of supported fiat assets.
 * @param supportedCountryCodes The bank's list of supported country codes.
 * @param routableAccounts Configuration for supporting creating routable bank accounts.
 */

data class PostBankBankModel (
    ...
    @SerializedName("type")
    val type: PostBankBankModel.Type,

    /* The bank's list of supported trading symbols. */
    @SerializedName("supported_trading_symbols")
    val supportedTradingSymbols: kotlin.collections.List<kotlin.String>,

    /* The bank's enabled features. */
    @SerializedName("features")
    val features: kotlin.collections.List<PostBankBankModel.Features>,

    /* The bank's list of supported fiat assets. */
    @SerializedName("supported_fiat_account_assets")
    val supportedFiatAccountAssets: kotlin.collections.List<kotlin.String>,
    ...
    @SerializedName("routable_accounts")
    val routableAccounts: PostBankBankModel.RoutableAccounts? = null
     ...
     * The bank's enabled features.
     *
     * Values: attestationIdentityRecords,kycIdentityVerifications,businessCustomers,individualCustomers
     */
    enum class Features(val value: kotlin.String) {
        ...
        @SerializedName(value = "business_customers") businessCustomers("business_customers"),
        @SerializedName(value = "individual_customers") individualCustomers("individual_customers");
    }
    /**
     * Configuration for supporting creating routable bank accounts.
     *
     * Values: unsupported,bank,customer
     */
    enum class RoutableAccounts(val value: kotlin.String) {
        @SerializedName(value = "unsupported") unsupported("unsupported"),
