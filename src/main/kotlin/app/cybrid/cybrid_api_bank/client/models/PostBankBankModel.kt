 ...
 * @param features The bank's enabled features. At present, both **attestation_identity_records** and **backstopped_funding_source** must be set.
 * @param supportedSavingsConfiguration The bank's list of supported savings asset by provider.
 */
...
data class PostBankBankModel (
    ...
    @SerializedName("supported_savings_configuration")
    val supportedSavingsConfiguration: kotlin.collections.Map<kotlin.String, kotlin.collections.List<kotlin.String>>? = null
