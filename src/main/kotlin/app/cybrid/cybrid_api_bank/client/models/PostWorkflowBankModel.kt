 ...
 * @param kind The Plaid workflow kind. Required when type is plaid.
 * @param customerGuid The customer identifier associated with the workflow. Optional when type is plaid and kind is link_token_create.
 * @param externalBankAccountGuid The external bank account identifier associated with the workflow. Required when type is plaid and kind is link_token_update.
 * @param language The language to initialize Plaid link. Required when type is plaid.
 * @param linkCustomizationName The customization name for Plaid link. Currently only supports the value \"default\". Required when type is plaid.
 * @param redirectUri The redirect URI for Plaid link. Optional when type is plaid.
 * @param androidPackageName The Android package name for Plaid link. Optional when type is plaid.
 */
