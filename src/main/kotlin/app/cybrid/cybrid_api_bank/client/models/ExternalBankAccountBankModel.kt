...
import app.cybrid.cybrid_api_bank.client.models.ExternalBankAccountBalancesBankModel
import app.cybrid.cybrid_api_bank.client.models.ExternalBankAccountPiiInnerBankModel
 ...
 * @param accountKind The type of account; one of plaid, plaid_processor_token, or raw_routing_details.
 * @param environment The environment that the external bank account is operating in; one of sandbox or production.
 ...
 * @param plaidInstitutionId The Plaid institution ID for the account.
 * @param plaidAccountMask The account number mask for the account.
 * @param plaidAccountName The name for the account.
 * @param state The state of the external bank account; one of storing, completed, failed, refresh_required, unverified, deleting, or deleted.
 * @param failureCode The failure code for failed transfers.
 * @param balanceUpdatedAt The timestamp that the balance information was last updated at.
 * @param balances 
 * @param pii The account holder information.
 */
...
data class ExternalBankAccountBankModel (
    ...
    val accountKind: kotlin.String? = null,
    ...
    val balanceUpdatedAt: java.time.OffsetDateTime? = null,

    @SerializedName("balances")
    val balances: ExternalBankAccountBalancesBankModel? = null,

    /* The account holder information. */
    @SerializedName("pii")
    val pii: kotlin.collections.List<ExternalBankAccountPiiInnerBankModel>? = null
