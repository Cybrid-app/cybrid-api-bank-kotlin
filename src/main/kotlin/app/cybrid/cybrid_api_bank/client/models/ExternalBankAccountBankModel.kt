...
data class ExternalBankAccountBankModel (
    ...
    val state: ExternalBankAccountBankModel.State? = null,
     ...
     * The state of the external bank account.
     *
     * Values: storing,completed,failed,refreshRequired,unverified,deleting,deleted
     */
    enum class State(val value: kotlin.String) {
        ...
        @SerializedName(value = "deleting") deleting("deleting"),
