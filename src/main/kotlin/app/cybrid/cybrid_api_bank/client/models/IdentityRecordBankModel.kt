...
import app.cybrid.cybrid_api_bank.client.models.AttestationDetailsBankModel
 ...
 * 
 *
 * @param guid Auto-generated unique identifier for the identity record.
 * @param customerGuid The customer's identifier.
 * @param type The identity record's type.
 * @param attestationDetails 
 * @param createdAt ISO8601 datetime the customer was created at.
 */

data class IdentityRecordBankModel (
    ...
    @SerializedName("type")
    val type: IdentityRecordBankModel.Type? = null,

    @SerializedName("attestation_details")
    val attestationDetails: AttestationDetailsBankModel? = null,
