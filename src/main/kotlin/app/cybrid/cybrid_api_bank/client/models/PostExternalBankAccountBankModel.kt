...
import app.cybrid.cybrid_api_bank.client.models.PostExternalBankAccountCounterpartyAddressBankModel
import app.cybrid.cybrid_api_bank.client.models.PostExternalBankAccountCounterpartyBankAccountBankModel
import app.cybrid.cybrid_api_bank.client.models.PostExternalBankAccountCounterpartyNameBankModel
 ...
 * @param asset The asset code. If not set will try and default to the Bank's configured fiat asset.
 * @param plaidPublicToken The public token for the account. Required for 'plaid' accounts. Required when account_kind is plaid.
 * @param plaidAccountId The account identifier in plaid. Required for 'plaid' accounts. Required when account_kind is plaid.
 * @param plaidProcessorToken The Plaid processor token used to access the account. Required when account_kind is plaid_processor_token.
 * @param plaidInstitutionId Plaid's institution ID for the account's institution. Required when account_kind is plaid_processor_token.
 * @param plaidAccountMask The account mask for the account. Required when account_kind is plaid_processor_token.
 * @param plaidAccountName The name of the account. Required when account_kind is plaid_processor_token.
 * @param counterpartyGuid The counterparty identifier. Optional when account_kind is raw_routing_details.
 * @param counterpartyBankAccount 
 * @param counterpartyName 
 * @param counterpartyAddress 
 * @param counterpartyEmailAddress The counterparty's email address on their checking account. Optional when account_kind is raw_routing_details and counterparty_guid is not present.
 */
...
data class PostExternalBankAccountBankModel (
    ...
    @SerializedName("plaid_processor_token")
    val plaidProcessorToken: kotlin.String? = null,

    /* Plaid's institution ID for the account's institution. Required when account_kind is plaid_processor_token. */
    @SerializedName("plaid_institution_id")
    ...
    @SerializedName("plaid_account_mask")
    val plaidAccountMask: kotlin.String? = null,

    /* The name of the account. Required when account_kind is plaid_processor_token. */
    @SerializedName("plaid_account_name")
    val plaidAccountName: kotlin.String? = null,
    ...
    @SerializedName("counterparty_bank_account")
    val counterpartyBankAccount: PostExternalBankAccountCounterpartyBankAccountBankModel? = null,

    @SerializedName("counterparty_name")
    val counterpartyName: PostExternalBankAccountCounterpartyNameBankModel? = null,

    @SerializedName("counterparty_address")
    val counterpartyAddress: PostExternalBankAccountCounterpartyAddressBankModel? = null,
    ...
    @SerializedName("counterparty_email_address")
    val counterpartyEmailAddress: kotlin.String? = null
     ...
     * The account type
     *
     * Values: plaid,plaidProcessorToken,rawRoutingDetails
     */
    enum class AccountKind(val value: kotlin.String) {
        @SerializedName(value = "plaid") plaid("plaid"),
        @SerializedName(value = "plaid_processor_token") plaidProcessorToken("plaid_processor_token"),
