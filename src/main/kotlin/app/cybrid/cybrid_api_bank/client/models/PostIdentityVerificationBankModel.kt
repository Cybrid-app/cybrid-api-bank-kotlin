 ...
 * @param name 
 * @param address 
 * @param dateOfBirth The customer's date of birth; required when method is set to 'attested'.
 * @param phoneNumber The customer's phone number.
 * @param emailAddress The customer's email address.
 * @param identificationNumbers The customer's identification numbers; required when method is set to 'attested'.
...
data class PostIdentityVerificationBankModel (
     ...
     * The identity verification method.
     *
     * Values: businessRegistration,idAndSelfie,taxIdAndSelfie,attested,plaidIdentityMatch,documentSubmission
     */
