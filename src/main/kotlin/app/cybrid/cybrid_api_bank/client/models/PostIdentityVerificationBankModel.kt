 ...
 * @param name 
 * @param address 
 * @param dateOfBirth The customer's date of birth. Required when type is kyc and method is attested.
 * @param identificationNumbers The customer's identification numbers. Required when type is kyc and method is attested.
 * @param externalBankAccountGuid The external bank account's identifier. Required when type is bank_account.
 * @param phoneNumber The customer's phone number. Optional when type is bank_account and method is attested or type is bank_account and method is attested_ownership.
 * @param emailAddress The customer's email address. Optional when type is bank_account and method is attested or type is bank_account and method is attested_ownership.
 */
...
data class PostIdentityVerificationBankModel (
     ...
     * The identity verification method. Required when type is counterparty, type is kyc, or type is bank_account.
     *
     * Values: watchlists,attested,documentSubmission,idAndSelfie,taxIdAndSelfie,businessRegistration,plaidIdentityMatch,attestedOwnership,accountOwnership
     */
