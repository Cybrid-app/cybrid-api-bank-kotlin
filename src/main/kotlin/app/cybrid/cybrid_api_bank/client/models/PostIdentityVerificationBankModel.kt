...
import app.cybrid.cybrid_api_bank.client.models.PostIdentityVerificationAliasesInnerBankModel
import app.cybrid.cybrid_api_bank.client.models.PostIdentityVerificationNameBankModel
import app.cybrid.cybrid_api_bank.client.models.PostUltimateBeneficialOwnerBankModel
 ...
 * @param customerGuid The customer's identifier. Required when type is kyc and method is attested_business_registration or type is kyc and method is attested_id_and_selfie.
 * @param expectedBehaviours The optional expected behaviour to simulate.
 * @param method The identity verification method. Required when type is counterparty, type is kyc, or type is bank_account.
 * @param counterpartyGuid The counterparty's identifier. Required when type is counterparty.
 * @param countryCode The ISO 3166 country 2-Alpha country the customer is being verified in. If not present, will default to the Bank's configured country code. Optional when type is kyc and method is id_and_selfie, type is kyc and method is tax_id_and_selfie, or type is kyc and method is business_registration.
 * @param name 
 * @param address 
 * @param dateOfBirth The customer's date of birth. Required when type is kyc and method is attested or type is kyc and method is attested_id_and_selfie.
 * @param identificationNumbers The customer's identification numbers. Required when type is kyc and method is attested, type is kyc and method is attested_business_registration, or type is kyc and method is attested_id_and_selfie.
 * @param aliases The aliases of the customer. Optional when type is kyc and method is attested_business_registration.
 * @param phoneNumber The customer's phone number. Required when type is kyc and method is attested_business_registration or type is kyc and method is attested_id_and_selfie. Optional when type is bank_account and method is attested_ownership.
 * @param emailAddress The customer's email address. Required when type is kyc and method is attested_business_registration or type is kyc and method is attested_id_and_selfie. Optional when type is bank_account and method is attested_ownership.
 * @param website The customer's website. Required when type is kyc and method is attested_business_registration.
 * @param natureOfBusiness The customer's nature of business. Required when type is kyc and method is attested_business_registration.
 * @param directorCustomerGuids The customer guids of the directors of the business Required when type is kyc and method is attested_business_registration.
 * @param ultimateBeneficialOwners The ultimate beneficial owners of the business with 10% or more ownership Required when type is kyc and method is attested_business_registration.
 * @param supportingFileGuids File guids supporting the verification Required when type is kyc and method is attested_business_registration or type is kyc and method is attested_id_and_selfie.
 * @param occupation The customer's occupation. Optional when type is kyc and method is attested_id_and_selfie.
 * @param externalBankAccountGuid The external bank account's identifier. Required when type is bank_account.
 */
...
data class PostIdentityVerificationBankModel (
    ...
    val method: PostIdentityVerificationBankModel.Method? = null,

    /* The counterparty's identifier. Required when type is counterparty. */
    @SerializedName("counterparty_guid")
    val counterpartyGuid: kotlin.String? = null,
    ...
    val aliases: kotlin.collections.List<PostIdentityVerificationAliasesInnerBankModel>? = null,
    ...
    val natureOfBusiness: kotlin.String? = null,
    ...
    @SerializedName("director_customer_guids")
    val directorCustomerGuids: kotlin.collections.List<kotlin.String>? = null,
    ...
    val ultimateBeneficialOwners: kotlin.collections.List<PostUltimateBeneficialOwnerBankModel>? = null,
    ...
    @SerializedName("supporting_file_guids")
    val supportingFileGuids: kotlin.collections.List<kotlin.String>? = null,
     ...
     * The identity verification method. Required when type is counterparty, type is kyc, or type is bank_account.
     *
     * Values: watchlists,attested,documentSubmission,enhancedDueDiligence,idAndSelfie,taxIdAndSelfie,businessRegistration,attestedIdAndSelfie,attestedBusinessRegistration,attestedOwnership,accountOwnership
     */
    enum class Method(val value: kotlin.String) {
        ...
        @SerializedName(value = "enhanced_due_diligence") enhancedDueDiligence("enhanced_due_diligence"),
        ...
        @SerializedName(value = "attested_id_and_selfie") attestedIdAndSelfie("attested_id_and_selfie"),
        @SerializedName(value = "attested_business_registration") attestedBusinessRegistration("attested_business_registration"),
