 ...
 * @param counterpartyGuid The counterparty's identifier.
...
data class PostIdentityVerificationBankModel (
     ...
     * The identity verification method.
     *
     * Values: attested,documentSubmission,idAndSelfie,taxIdAndSelfie,businessRegistration,plaidIdentityMatch,attestedOwnership,accountOwnership,watchlists
     */
