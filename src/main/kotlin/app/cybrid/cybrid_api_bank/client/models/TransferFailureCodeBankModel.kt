 ...
 * 
 *
 * Values: nonSufficientFunds,refreshRequired,partyNameInvalid,paymentRailInvalid,complianceRejection,cancelled,reversed,limitExceeded,networkFeeTooLow,amountTooLow,internalError,invalidAddress,invalidDestination,customerActionRequired,externalVendorError
 */
...
enum class TransferFailureCodeBankModel(val value: kotlin.String) {
    ...
    @SerializedName(value = "internal_error")
    internalError("internal_error"),

    @SerializedName(value = "invalid_address")
    invalidAddress("invalid_address"),

    @SerializedName(value = "invalid_destination")
    invalidDestination("invalid_destination"),

    @SerializedName(value = "customer_action_required")
    customerActionRequired("customer_action_required"),

    @SerializedName(value = "external_vendor_error")
