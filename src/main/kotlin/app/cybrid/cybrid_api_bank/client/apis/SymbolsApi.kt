...
class SymbolsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    suspend fun listSymbols() : kotlin.collections.List<kotlin.String> = withContext(Dispatchers.IO) {
        val localVarResponse = listSymbolsWithHttpInfo()
    ...
    */
    ...
    suspend fun listSymbolsWithHttpInfo() : ApiResponse<kotlin.collections.List<kotlin.String>?> = withContext(Dispatchers.IO) {
        val localVariableConfig = listSymbolsRequestConfig()
    ...
    /**
    * To obtain the request config of the operation listSymbols
    *
    * @return RequestConfig
    */
    fun listSymbolsRequestConfig() : RequestConfig<Unit> {
