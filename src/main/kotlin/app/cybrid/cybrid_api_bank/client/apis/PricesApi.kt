...
class PricesApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    suspend fun listPrices(symbol: kotlin.String?) : kotlin.collections.List<SymbolPriceBankModel> = withContext(Dispatchers.IO) {
        val localVarResponse = listPricesWithHttpInfo(symbol = symbol)

        return@withContext when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.collections.List<SymbolPriceBankModel>
    ...
    * Retrieves a listing of symbol prices.  ## Symbols  Symbol are pairs and are in the format asset-counter_asset, e.g., &#39;BTC-USD&#39; for the Bitcoin/ USD pair. See the Symbols API for a complete list of cryptocurrencies supported.    Required scope: **prices:read**
    * @param symbol Comma separated symbols to list prices for. (optional)
    * @return ApiResponse<kotlin.collections.List<SymbolPriceBankModel>?>
    * @throws IllegalStateException If the request is not correctly configured
    * @throws IOException Rethrows the OkHttp execute method exception
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun listPricesWithHttpInfo(symbol: kotlin.String?) : ApiResponse<kotlin.collections.List<SymbolPriceBankModel>?> = withContext(Dispatchers.IO) {
        val localVariableConfig = listPricesRequestConfig(symbol = symbol)

        return@withContext request<Unit, kotlin.collections.List<SymbolPriceBankModel>>(
            localVariableConfig
        )
    }

    /**
    * To obtain the request config of the operation listPrices
    *
    * @param symbol Comma separated symbols to list prices for. (optional)
    * @return RequestConfig
    */
    fun listPricesRequestConfig(symbol: kotlin.String?) : RequestConfig<Unit> {
