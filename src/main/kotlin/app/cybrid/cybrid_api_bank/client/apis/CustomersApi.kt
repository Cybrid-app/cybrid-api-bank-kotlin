...
class CustomersApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    suspend fun createCustomer(postCustomerBankModel: PostCustomerBankModel) : CustomerBankModel = withContext(Dispatchers.IO) {
        val localVarResponse = createCustomerWithHttpInfo(postCustomerBankModel = postCustomerBankModel)

        return@withContext when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as CustomerBankModel
    ...
    * Creates a customer.  ## Customer Type  Customer resources are an abstraction for real world individuals and businesses on the Cybrid Platform and are used throughout the platform to perform high level operations, e.g., create a quote, execute a trade, etc..  Customers can have additional resources attached to them, e.g., identity records, accounts, etc.  At present, Customer&#39;s can be created with type &#x60;individual&#x60;.    Required scope: **customers:execute**
    * @param postCustomerBankModel  
    * @return ApiResponse<CustomerBankModel?>
    * @throws IllegalStateException If the request is not correctly configured
    * @throws IOException Rethrows the OkHttp execute method exception
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun createCustomerWithHttpInfo(postCustomerBankModel: PostCustomerBankModel) : ApiResponse<CustomerBankModel?> = withContext(Dispatchers.IO) {
        val localVariableConfig = createCustomerRequestConfig(postCustomerBankModel = postCustomerBankModel)

        return@withContext request<PostCustomerBankModel, CustomerBankModel>(
            localVariableConfig
        )
    }
    ...
    */
    fun createCustomerRequestConfig(postCustomerBankModel: PostCustomerBankModel) : RequestConfig<PostCustomerBankModel> {
        val localVariableBody = postCustomerBankModel
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getCustomer(customerGuid: kotlin.String) : CustomerBankModel = withContext(Dispatchers.IO) {
        val localVarResponse = getCustomerWithHttpInfo(customerGuid = customerGuid)
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun getCustomerWithHttpInfo(customerGuid: kotlin.String) : ApiResponse<CustomerBankModel?> = withContext(Dispatchers.IO) {
        val localVariableConfig = getCustomerRequestConfig(customerGuid = customerGuid)

        return@withContext request<Unit, CustomerBankModel>(
            localVariableConfig
        )
    }
    ...
    * @return RequestConfig
    */
    fun getCustomerRequestConfig(customerGuid: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/api/customers/{customer_guid}".replace("{"+"customer_guid"+"}", "$customerGuid"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listCustomers(page: kotlin.Int?, perPage: kotlin.Int?) : CustomerListBankModel = withContext(Dispatchers.IO) {
        val localVarResponse = listCustomersWithHttpInfo(page = page, perPage = perPage)

        return@withContext when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as CustomerListBankModel
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    * @param page  (optional, default to 0)
    * @param perPage  (optional, default to 10)
    * @return ApiResponse<CustomerListBankModel?>
    * @throws IllegalStateException If the request is not correctly configured
    * @throws IOException Rethrows the OkHttp execute method exception
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun listCustomersWithHttpInfo(page: kotlin.Int?, perPage: kotlin.Int?) : ApiResponse<CustomerListBankModel?> = withContext(Dispatchers.IO) {
        val localVariableConfig = listCustomersRequestConfig(page = page, perPage = perPage)

        return@withContext request<Unit, CustomerListBankModel>(
            localVariableConfig
        )
    }
    ...
    * @return RequestConfig
    */
    fun listCustomersRequestConfig(page: kotlin.Int?, perPage: kotlin.Int?) : RequestConfig<Unit> {
        val localVariableBody = null
