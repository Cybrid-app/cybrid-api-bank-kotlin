...
class AssetsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    suspend fun listAssets(page: kotlin.Int?, perPage: kotlin.Int?) : AssetListBankModel = withContext(Dispatchers.IO) {
        val localVarResponse = listAssetsWithHttpInfo(page = page, perPage = perPage)

        return@withContext when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as AssetListBankModel
    ...
    * @param page The page index to retrieve. (optional, default to 0)
    * @param perPage The number of entities per page to return. (optional, default to 10)
    * @return ApiResponse<AssetListBankModel?>
    * @throws IllegalStateException If the request is not correctly configured
    * @throws IOException Rethrows the OkHttp execute method exception
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun listAssetsWithHttpInfo(page: kotlin.Int?, perPage: kotlin.Int?) : ApiResponse<AssetListBankModel?> = withContext(Dispatchers.IO) {
        val localVariableConfig = listAssetsRequestConfig(page = page, perPage = perPage)

        return@withContext request<Unit, AssetListBankModel>(
            localVariableConfig
        )
    }
    ...
    */
    fun listAssetsRequestConfig(page: kotlin.Int?, perPage: kotlin.Int?) : RequestConfig<Unit> {
