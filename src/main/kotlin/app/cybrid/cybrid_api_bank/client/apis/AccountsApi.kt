...
class AccountsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    suspend fun createAccount(postAccountBankModel: PostAccountBankModel) : AccountBankModel = withContext(Dispatchers.IO) {
        val localVarResponse = createAccountWithHttpInfo(postAccountBankModel = postAccountBankModel)

        return@withContext when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as AccountBankModel
    ...
    * Creates an account.  ## Account Type  An Account is tied to a specific cryptocurrency and is comprised of transactions and a current balance.  An account is required to allow a Customer to hold cryptocurrency on the Cybrid Platform.  At present, account&#39;s can be created as &#x60;trading&#x60; accounts and are required before a Customer can generate a quote and execute a trade.  ## Asset  The asset is the specific cryptocurrency that the account holds, e.g., &#39;BTC&#39; for Bitcoin. See the Symbols API for a complete list of cryptocurrencies supported.     Required scope: **accounts:execute**
    * @param postAccountBankModel  
    * @return ApiResponse<AccountBankModel?>
    * @throws IllegalStateException If the request is not correctly configured
    * @throws IOException Rethrows the OkHttp execute method exception
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun createAccountWithHttpInfo(postAccountBankModel: PostAccountBankModel) : ApiResponse<AccountBankModel?> = withContext(Dispatchers.IO) {
        val localVariableConfig = createAccountRequestConfig(postAccountBankModel = postAccountBankModel)

        return@withContext request<PostAccountBankModel, AccountBankModel>(
            localVariableConfig
        )
    }
    ...
    */
    fun createAccountRequestConfig(postAccountBankModel: PostAccountBankModel) : RequestConfig<PostAccountBankModel> {
        val localVariableBody = postAccountBankModel
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun getAccount(accountGuid: kotlin.String) : AccountBankModel = withContext(Dispatchers.IO) {
        val localVarResponse = getAccountWithHttpInfo(accountGuid = accountGuid)
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun getAccountWithHttpInfo(accountGuid: kotlin.String) : ApiResponse<AccountBankModel?> = withContext(Dispatchers.IO) {
        val localVariableConfig = getAccountRequestConfig(accountGuid = accountGuid)

        return@withContext request<Unit, AccountBankModel>(
            localVariableConfig
        )
    }
    ...
    * @return RequestConfig
    */
    fun getAccountRequestConfig(accountGuid: kotlin.String) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/api/accounts/{account_guid}".replace("{"+"account_guid"+"}", "$accountGuid"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    suspend fun listAccounts(page: kotlin.Int?, perPage: kotlin.Int?, guid: kotlin.String?) : AccountListBankModel = withContext(Dispatchers.IO) {
        val localVarResponse = listAccountsWithHttpInfo(page = page, perPage = perPage, guid = guid)

        return@withContext when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as AccountListBankModel
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    * @param perPage The number of entities per page to return. (optional, default to 10)
    * @param guid Comma separated account_guids to list accounts for. (optional)
    * @return ApiResponse<AccountListBankModel?>
    * @throws IllegalStateException If the request is not correctly configured
    * @throws IOException Rethrows the OkHttp execute method exception
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    suspend fun listAccountsWithHttpInfo(page: kotlin.Int?, perPage: kotlin.Int?, guid: kotlin.String?) : ApiResponse<AccountListBankModel?> = withContext(Dispatchers.IO) {
        val localVariableConfig = listAccountsRequestConfig(page = page, perPage = perPage, guid = guid)

        return@withContext request<Unit, AccountListBankModel>(
            localVariableConfig
        )
    }
    ...
    * @return RequestConfig
    */
    fun listAccountsRequestConfig(page: kotlin.Int?, perPage: kotlin.Int?, guid: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
