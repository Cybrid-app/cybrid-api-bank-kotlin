...
## Documentation for Models
 ...
 - [app.cybrid.cybrid_api_bank.client.models.ExchangeSettlementBankModel](docs/ExchangeSettlementBankModel.md)
 - [app.cybrid.cybrid_api_bank.client.models.ExchangeSettlementExpectedPaymentBankModel](docs/ExchangeSettlementExpectedPaymentBankModel.md)
 - [app.cybrid.cybrid_api_bank.client.models.ExchangeSettlementObligationBankModel](docs/ExchangeSettlementObligationBankModel.md)
 - [app.cybrid.cybrid_api_bank.client.models.ExchangeSettlementPaymentOrderBankModel](docs/ExchangeSettlementPaymentOrderBankModel.md)
